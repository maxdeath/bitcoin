...
static UniValue gettxoutproof(const JSONRPCRequest& request)
{
    ...
    CDataStream ssMB(SER_NETWORK, BTC_PROTOCOL_VERSION | SERIALIZE_TRANSACTION_NO_WITNESS);
...
static UniValue verifytxoutproof(const JSONRPCRequest& request)
{
    ...
    CDataStream ssMB(ParseHexV(request.params[0], "proof"), SER_NETWORK, BTC_PROTOCOL_VERSION | SERIALIZE_TRANSACTION_NO_WITNESS);
